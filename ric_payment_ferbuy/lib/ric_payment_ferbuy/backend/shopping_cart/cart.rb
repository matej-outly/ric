	...
	class Backend
		module ShoppingCart
			class Cart
				...
				def subtotal
					return self.number_with_decimal(self.subtotal_without_decimal)
				end
				...
				def total
					return self.number_with_decimal(self.total_without_decimal)
				end
				...
				def discount
					return self.number_with_decimal(self.discount_without_decimal)
				end
				...
				def tax
					return self.number_with_decimal(self.tax_without_decimal)
				end
				...
				def shipping
					return self.number_with_decimal(self.shipping_without_decimal)
				end
			...
			protected
				...
				def number_with_decimal(number)
					return (number / 100).to_f
				end
