module RicReservation
	module WeekTimetableHelper
		...
		#
		def week_timetable_find_items_by_day(items, day, min_hour, max_hour)
			result = []
			items.each do |item|
				if item[:day] == day 
		...
		# Get item label
		#
		def week_timetable_item_label(item)
		...
		#
		def week_timetable_items(date, data, options = {})
		...
		#
		def week_timetable_hours(date, items, options = {})
		...
		#
		def week_timetable_render(items, hours, days, options = {})
